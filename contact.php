                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-offset-1 col-md-10 col-lg-offset-2 col-lg-8">
                            <div class="page-title text-center">
                                ...
                                <p>Do you have anything to say or have anything to suggest me? Or you are thinking to do you planning your next project with me? Let me know!</p>
                            </div>
                        </div>
                    </div> <!-- /.row -->
                        ...
                        <div class="col-xs-12 col-sm-5 col-md-4 col-lg-3">
                            <div class="contact-block">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4>Email</h4>
                                        <p><a href="mailto:polash.sahel@gmail.com">polash.sahel@gmail.com</a></p>
                                    </div>
                                </div>
                            </div>
                            <!-- /.contact-block -->
                            <div class="contact-block">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4>Phone</h4>
                                        <p><a href="tel:+8801783357375">+88-01783357375</a></p>
                                    </div>
                                </div>
                            </div>
                            <!-- /.contact-block -->
                            <div class="contact-block">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4>Skype</h4>
                                        <p><a href="skype:polashchaipara">polashchaipara</a></p>
                                    </div>
                                </div>
                            </div>
                            <!-- /.contact-block -->
                            ...
                            <ul class="contact-social">
                                <li>
                                    ...
                                    <a href="https://web.facebook.com/piarujjamanpolash"><i class="tf-ion-social-facebook"></i></a>
                                </li>
                                <li>
                                    <span class="contact-social-hex"></span>
                                    <a href="https://twitter.com/PiarujjamanPol1"><i class="tf-ion-social-twitter"></i></a>
                                </li>
                                <li>
                                    <span class="contact-social-hex"></span>
                                    <a href="https://www.linkedin.com/in/piarujjaman-polash-621530168"><i class="tf-ion-social-linkedin"></i></a>
                                </li>
                                <li>
                                    <span class="contact-social-hex"></span>
                                    <a href="https://github.com/PiarujjamanPolash"><i class="tf-ion-social-github"></i></a>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div class="col-xs-12 col-sm-12">
                                    <div class="input-field">
                                        <span class="btn-border">
                                            <button name="submit" type="submit" class="btn btn-primary btn-custom-border text-uppercase">Send Message now</button>
                                        </span>
                                    </div>
                ...
                <nav class="page-nav clear">
                    <div class="container">
                        <div class="flex flex-middle space-between">
                            ...
                            <span class="copyright hidden-xs">Copyright &copy; 2020 piarujjaman polash, All Rights Reserved.</span>
                        </div>
                    </div>
                    <!-- /.page-nav -->
                </nav>
